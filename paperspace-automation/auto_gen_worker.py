...
try:
    import gdrive_uploader as _gdrive_uploader
...
def generate(payload: dict, index: int, timeout: int = 600) -> dict | None:
    try:
...
def _cleanup_local(outpath: str):
    """Drive アップロード成功後、WebUI が保存したローカルファイルを削除。"""
